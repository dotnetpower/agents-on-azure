# AutoGen — Multi-Agent Event Grid Pipeline

## Overview

Demonstrates a **three-agent document analysis pipeline** built with
[AutoGen](https://github.com/microsoft/autogen) where agents communicate
through **Azure Event Grid** (publish) and **Azure Storage Queues**
(subscribe/receive).
...
sequenceDiagram
    ...
    participant A as Analyzer (AG)
    participant S as Summarizer (AG)
    participant R as Reviewer (AG)
