"""Azure Event Grid publish helpers.

Uses DefaultAzureCredential for authentication.
Publishes CloudEvents to an Event Grid topic.
"""
...
class EventGridPublisher:
    """Async helper for publishing events to Azure Event Grid."""

    def __init__(
        self,
        endpoint: str | None = None,
    ) -> None:
        self._endpoint = endpoint or os.environ["AZURE_EVENTGRID_ENDPOINT"]
